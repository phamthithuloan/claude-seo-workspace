...
```
.claude/skills/             # 3 personal skills (project-level)
...
├── chat-history-2026-05-18.txt         # Lịch sử trò chuyện (/export)
...
- 3 skills này được build cho Seongon Content workflow (SEO content tiếng Việt cho client y tế).
